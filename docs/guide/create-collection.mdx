...
<div style={{textAlign: 'center'}}>
    <img src="/img/screenshots/hyperboard-example.png" alt="hyperboard example" style={{ maxWidth: '700px', width: '100%' }}/>
<p style={{ marginTop: '6px', fontStyle: 'italic' }}>Example of a hyperboard</p>
</div>  

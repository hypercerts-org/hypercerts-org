        ...
        <div>
          ...
          <div className={`mt-8 space-y-6 ${bodyCopy}`}>
            <p>
              ...
              and AI safety research, valuable work depends on the people doing
              it being able to explain it, and the people funding it being able
              to judge it.
            </p>
            <p>
              Today that work is repeated for every funding decision. The
              friction takes time away from the work itself, and what one round
              learns rarely reaches the next.
            </p>
          </div>
        </div>
